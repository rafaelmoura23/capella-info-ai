...
<head>
    ...
    <title>CapellaInfo - Criar Conta</title>
    <!-- Tailwind CSS CDN -->
    ...
    <div class="flex items-center justify-center min-h-screen px-4 sm:px-6 lg:px-8">
        <div class="w-full max-w-sm glass-effect p-8 rounded-xl" data-aos="zoom-in" data-aos-duration="1000">
            ...
            <div class="text-center mb-6">
                <h2 class="text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-500" style="font-family: 'Orbitron', sans-serif;">Criar Conta</h2>
            </div>
            ...
            <form method="POST" action="{{ route('register') }}" class="space-y-6">
                ...
                <div class="text-center">
                    <a href="{{ route('login') }}" class="text-sm font-light text-gray-400 hover:text-blue-400 transition-colors">
