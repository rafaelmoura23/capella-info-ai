...
<div class="flex items-center justify-center py-8 px-4 sm:px-6 lg:px-8">
    <div class="w-full max-w-sm bg-white p-8 rounded-lg shadow-sm border border-slate-100">
        ...
        <div class="text-center mb-6">
            <h2 class="text-2xl font-light tracking-wide text-slate-800">Criar Conta</h2>
        </div>
        ...
        <form method="POST" action="{{ route('register') }}" class="space-y-4">
            ...
            <div class="text-center">
                <a href="{{ route('login') }}" class="text-sm font-light text-slate-600 hover:text-slate-800 transition-colors">
